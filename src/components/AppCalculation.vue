<template>
    <div class="container-app-calculation" id="result">
        ...
        <div class="container-app-calculation-wrapper">
            <div class="table-scroll" v-if="isPower">
                <table class="table-scroll-content">
                    <thead>
                        <tr>
                            <td>{{fromBaseName}} to Decimal</td>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
            ...
            <h2 class="title" v-if="isComputed && isTable">{{fromBaseName}} to {{toBaseName}}</h2>
...
<script>
    export default {
        ...
        props: {
            number: String,
            numberIndependent: String,
            fromBase: String,
            fromBaseIndependent: String,
            fromBaseName: String,
            toBase: String,
            toBaseIndependent: String,
            toBaseName: String,
            toDecimal: String,
            powerCalculation: Array,
            calculation: Array,
